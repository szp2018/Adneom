...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 07 déc. 2018 à 13:03
...
CREATE TABLE `info` (
  ...
  `chainedorig` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nbsaison` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nbepisodes` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `info` (`id`, `genre`, `creation`, `pays`, `chainedorig`, `nbsaison`, `nbepisodes`, `duree`, `acteurs`) VALUES
(1, 'science-fiction Horreur Satire Thriller Drame', 'Charlie Brooker\r\n', 'Royaume-Uni\r\n', 'Channel 4 (2011 à 2014) Netflix (2016 - en cours)\r\n', '4', '19', 'de 40 à 90 minutes', 'Hannah John-Kamen, Michaela Coel, Beatrice Robertson-Jones,');
